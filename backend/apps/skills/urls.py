...
urlpatterns = [
    ...
    path("skills/<uuid:skill_id>/related/", RelatedSkillsView.as_view(), name="related-skills"),
    
    # Occupations
    path("occupations/", OccupationListView.as_view(), name="occupation-list"),
    path("occupations/<uuid:id>/", OccupationDetailView.as_view(), name="occupation-detail"),
    path("occupations/<uuid:occupation_id>/skills/", OccupationWithSkillsView.as_view(), name="occupation-skills"),
    ...
    path("career-paths/<uuid:id>/", CareerPathDetailView.as_view(), name="career-path-detail"),
    path("occupations/<uuid:occupation_id>/career-paths/", CareerPathsFromOccupationView.as_view(), name="occupation-career-paths"),
