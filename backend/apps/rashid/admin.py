"""
Admin configuration for Rashid AI Assistant
"""
...
class RashidConfigAdmin(admin.ModelAdmin):
...
class RashidProfileAdmin(admin.ModelAdmin):
...
class RashidMessageInline(admin.TabularInline):
...
class RashidConversationAdmin(admin.ModelAdmin):
...
class RashidMessageAdmin(admin.ModelAdmin):
...
class RashidStoryBankAdmin(admin.ModelAdmin):
...
class RashidUsageAdmin(admin.ModelAdmin):
